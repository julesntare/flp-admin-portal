...
import { SearchResultInitialState, TabDataItems } from "../../Types/SearchResultType";

export const fetchSearchData = createAsyncThunk<TabDataItems[], void, {}>("fetch/searchResult", async () => {
