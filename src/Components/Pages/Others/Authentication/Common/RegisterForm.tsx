...
import { Agreewith, CreateAccount, CreateYourAccount, EmailAddress, Href, Password, PrivacyPolicy, SignIn, YourName } from '../../../../../Utils/Constants';
            ...
            <div className="login-main">
                <Form className="theme-form" onSubmit={handleSubmit}>
                    ...
                    <FormGroup className='mb-0'>
                        ...
                        <Btn color='primary' className='btn-block w-100'>{CreateAccount}</Btn>
                    </FormGroup>
