...
import { AccountName, Continue, Email, Previous, ProjectDescription, SelectTeamWith } from '../../../../../Utils/Constants';
        ...
        <Form onSubmit={(event) => event.preventDefault()} className="needs-validation" noValidate>
            <Row className='g-3'>
                ...
                <Col xs={12} className="text-end">
                    <Btn onClick={() => activeCallBack(1)} color="primary me-2">{Previous}</Btn>
