        ...
        <Form onSubmit={(e) => e.preventDefault()} className="needs-validation" noValidate>
            <Row className='g-3'>
                ...
                <Col xl={4} xs={12}>
                    ...
                    <Input type="email" placeholder="dunzo@example.com" value={email} name="email" onChange={updateFormData} />
                </Col>
                <Col xl={5} sm={4}>
                    <Label>{State}</Label>
                ...
                <Col xl={3} sm={4}>
                    <Label>{ZipCode}</Label>
                    <Input type="text" value={zip} name="zip" onChange={updateFormData} />
                </Col>
                <Col sm={4}>
