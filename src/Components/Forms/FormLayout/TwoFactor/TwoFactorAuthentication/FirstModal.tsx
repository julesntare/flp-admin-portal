...
import { FirstModalPropsType } from '../../../../../Types/FormType'
...
import { modalOneData } from '../../../../../Data/Forms/FormLayoutData';

export default function FirstModal({ toggle, modalOne }: FirstModalPropsType) {
