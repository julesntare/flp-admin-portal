...
import { SecondModalPropsType } from '../../../../../Types/FormType'
...
export default function SecondModal({ modal2, toggle2 }: SecondModalPropsType) {
                    ...
                    <div className="modal-img">
                        ...
                        <div className="qr-content">
                            <Alerts color='light-dark' className={`light alert-dismissible text-dark border-left-wrapper ${active ? "show" : "d-none"}`}>
                                ...
                                <Btn color='transparent' className="btn-close" onClick={() => { setActive(false) }} />
                            </Alerts>
                        </div>
                    </div>
