...
import { verticalValidationWizardSubTitle } from '../../../../../Data/Forms/FormLayoutData';
...
export default function VerticalValidationWizard() {
    ...
    return (
        <Col md={12}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={VerticalValidationWizardTitle} subTitle={verticalValidationWizardSubTitle} />
                <CardBody>
                        ...
                        <Row className="g-3">
                            ...
                            <Col xxl={9} xl={8} xs={12}>
                                ...
                                <Col xs={12} className="text-end">
                                    {steps === 2 && <Btn onClick={() => activeCallBack(1)} color="primary me-1">{Previous}</Btn>}
