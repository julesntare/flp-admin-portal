...
import { Next, Previous, StudentValidationFormTitle } from '../../../../../Utils/Constants';
import { studentValidationFormSubTitle } from '../../../../../Data/Forms/FormLayoutData';
    ...
    return (
        <Col xl={6}>
            <Card className="height-equal">
                <CommonCardHeader headClass='pb-0' title={StudentValidationFormTitle} subTitle={studentValidationFormSubTitle} />
                <CardBody className="custom-input">
                    <Form className="form-wizard" id="regForm">
                        ...
                        <div className='text-end pt-3'>
                            {step > 1 && (<Btn color="secondary me-1" onClick={handleBackButton}>{Previous}</Btn>)}
