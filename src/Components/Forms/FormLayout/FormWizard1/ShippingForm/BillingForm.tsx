...
import { Address, BillingInformation, ContactNumber, Country, Email, FillFollowingInformation, FirstName, LastName, OtherNotes, ProceedToNext, RememberMeNext, State, ZipCode } from '../../../../../Utils/Constants';
import { countryData } from '../../../../../Data/Forms/FormLayoutData';
            ...
            <Form onSubmit={(event) => event.preventDefault} className="needs-validation " noValidate>
                <Row className='g-3'>
                    ...
                    <Col sm={6}>
                        ...
                        <Input value={email} onChange={updateFormData} name="email" type="email" placeholder="dunzo@example.com" />
                    </Col>
                    <Col xs={12}>
                        <Label>{Address} </Label>
