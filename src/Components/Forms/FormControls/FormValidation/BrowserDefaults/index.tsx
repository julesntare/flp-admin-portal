...
import { AgreePolicy, BrowserDefaultsTitle, ChooseFile, ConfirmationText, DescriptionLabel, EmailAddress, FirstName, Password, State, SubmitButton } from '../../../../../Utils/Constants';
import { browserDefaultsSubTitle } from '../../../../../Data/Forms/FormControlsData';
    ...
    return (
        <Col xl={6}>
            <Card className="height-equal">
                <CommonCardHeader headClass='pb-0' title={BrowserDefaultsTitle} subTitle={browserDefaultsSubTitle} />
                        ...
                        <Row className="g-3">
                            ...
                            <Col xs={12}>
                                <FormGroup check switch>
                                    <Input type="checkbox" id="flexSwitchCheckDefault" role="switch" required />
