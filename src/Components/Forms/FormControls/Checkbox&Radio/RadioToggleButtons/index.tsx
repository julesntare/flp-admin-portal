...
import { radioToggleButtonsSubTitle } from '../../../../../Data/Forms/FormControlsData'
...
export default function RadioToggleButtons() {
    ...
    return (
        <Col md={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={RadioToggleButtonsTitle} subTitle={radioToggleButtonsSubTitle} />
