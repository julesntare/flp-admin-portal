            ...
            <div className="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div className="form-check-size">
                    ...
                    <FormGroup check switch inline>
                        <Input className="check-size" id="flexSwitchCheckDefault3" type="checkbox" role="switch" />
                    </FormGroup>
                    <FormGroup check switch inline>
                        <Input className="check-size" id="flexSwitchCheckDisabled3" type="checkbox" role="switch" disabled />
                    </FormGroup>
                </div>
            </div>
        </Col>
