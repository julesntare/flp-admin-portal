...
import { imageWithCheckboxData, imagesWithCheckBoxSubTitle } from '../../../../../Data/Forms/FormControlsData'
...
export default function ImagesWithCheckbox() {
    ...
    return (
        <Col xs={12}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={ImagesCheckboxTitle} subTitle={imagesWithCheckBoxSubTitle} />
                <CardBody>
                                ...
                                <Col xxl={3} sm={6} key={data.id}>
                                    <div className="card-wrapper border rounded-3 checkbox-checked">
                                        ...
                                        <div className="img-checkbox">
                                            <Input className="main-img-cover" id={`img-check-${data.id}`} type="checkbox" defaultChecked={data.check === 'checked'} disabled={data.disabled === 'disabled'} />
