...
import { romanOpenMenu } from '../../../../../Data/Forms/FormControlsData'
    ...
    return (
        <Col>
            ...
            <Row className="mb-3">
                ...
                <Col sm={9}><InputGroup className="mb-3"><InputGroupText>{'@'}</InputGroupText>
            ...
            <Row className="mb-3">
                <Col sm={3}><Label>{InputGroupTitle}</Label></Col>
                <Col sm={9}><InputGroup className="has-validation"><InputGroupText>{'@'}</InputGroupText>
                    <div className='form-floating'>
                        <Input id="floatingInputGroup2" type="text" invalid required />
