...
import { flatInputStyleSubTitle, multiplePaintingFlatData, romanFlatInputData } from '../../../../../Data/Forms/FormControlsData'
...
export default function FlatInputStyle() {
    ...
    return (
        <Col md={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={FlatInputStyleTitle} subTitle={flatInputStyleSubTitle} />
