...
import { colorsListBaseInput, pixelstrapRaisetList, raiseInputStyleSubTitle } from '../../../../../Data/Forms/FormControlsData';
...
export default function RaiseInputStyle() {
    ...
    return (
        <Col md={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={RaiseInputStyleTitle} subTitle={raiseInputStyleSubTitle} />
