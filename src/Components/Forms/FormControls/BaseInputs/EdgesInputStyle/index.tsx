...
import { Comments, DefaultFileText, DefaultInput, EdgesInputStyleTitle, EmailAddress, Password, PixelstrapThemeTitle } from '../../../../../Utils/Constants';
import { edgesInputStyleSubTitle, pixelstrapEdgestList } from '../../../../../Data/Forms/FormControlsData';
...
export default function EdgesInputStyle() {
    ...
    return (
        <Col md={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={EdgesInputStyleTitle} subTitle={edgesInputStyleSubTitle} />
                <Form className="theme-form dark-inputs" onSubmit={handleSubmit}>
                    <CardBody>
                        ...
                        <Row><CommonSelectDropdown title={PixelstrapThemeTitle} inputClass='btn-pill digits' options={pixelstrapEdgestList} /></Row>
                        <Row>
                            <Col>
                                <FormGroup>
