...
import { customFileInputSubTitle } from '../../../../../Data/Forms/FormControlsData';
    ...
    return (
        <Col xl={6}>
            <Card className="height-equal">
                <CommonCardHeader headClass='pb-0' title={CustomFileInputTitle} subTitle={customFileInputSubTitle} />
                <CardBody className="main-custom-form input-group-wrapper">
                    ...
                    <InputGroup>
                        <Btn color='success' id="inputGroupFileAddon03" outline><i className="icofont icofont-ui-copy"></i></Btn>
