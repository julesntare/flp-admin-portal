...
import { checkBoxesAndRadiosSubTitle } from '../../../../../Data/Forms/FormControlsData';
    ...
    return (
        <Col md={6}>
            <Card className="height-equal">
                <CommonCardHeader headClass='pb-0' title={CheckboxesAndRadiosTitle} subTitle={checkBoxesAndRadiosSubTitle} />
