...
import { varationOfAddonsSubTitle } from '../../../../../Data/Forms/FormControlsData'
...
export default function VariationAddons() {
    ...
    return (
        <Col xl={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={VariationAddonsTitle} subTitle={varationOfAddonsSubTitle} />
