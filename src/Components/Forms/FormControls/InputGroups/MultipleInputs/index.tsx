...
import { multipleInputsSubTitle } from '../../../../../Data/Forms/FormControlsData';
...
export default function MultipleInputs() {
    ...
    return (
        <Col md={6}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={MultipleInputsTitle} subTitle={multipleInputsSubTitle} />
