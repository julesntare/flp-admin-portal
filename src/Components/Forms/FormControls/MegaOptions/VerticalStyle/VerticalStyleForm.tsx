...
import { verticalStyleFormData } from '../../../../../Data/Forms/FormControlsData'
                                ...
                                <Card className={item.cardClass}>
                                    <div className="d-flex p-20">
                                        <FormGroup className={`radio radio-${item.color} m-0 w-100`} check>
                                            <Input id={`radios${item.id}`} type="radio" name={item.name} value="option1" defaultChecked={item.check === "checked"} />
