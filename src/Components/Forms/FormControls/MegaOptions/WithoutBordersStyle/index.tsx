...
import { withoutBordersStyleSubTitle } from '../../../../../Data/Forms/FormControlsData'
...
export default function WithoutBordersStyle() {
    ...
    return (
        <Col sm={12} xxl={6} className="box-col-6">
            <Card>
                <CommonCardHeader headClass='pb-0' title={WithoutBordersStyleTitle} subTitle={withoutBordersStyleSubTitle} />
                <CardBody>
