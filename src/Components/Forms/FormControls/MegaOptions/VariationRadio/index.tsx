...
import { variationRadioData, variationRadioSubTitle } from '../../../../../Data/Forms/FormControlsData'
...
export default function VariationRadio() {
    ...
    return (
        <Col xs={12}>
            <Card>
                <CommonCardHeader headClass='pb-0' title={VariationRadioTitle} subTitle={variationRadioSubTitle} />
                <CardBody>
                    <Row className="g-3">
                                        ...
                                        <div className="payment-wrapper" key={item.id}>
                                            <div className="payment-first">
                                                <FormGroup className="radio radio-primary" check>
                                                    <Input id={`ptm${item.id}`} type="radio" name={item.name} value="option1" defaultChecked={item.check === 'checked'} />
