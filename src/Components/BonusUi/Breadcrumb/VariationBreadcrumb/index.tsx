...
import { variationBreadcrumbSubTitle } from '../../../../Data/BonusUiData/BreadcrumbData'

export default function VariationBreadcrumb() {
    return (
        <Col sm={6}>
            <Card className='height-equal'>
                <CommonCardHeader headClass='pb-0' title={VariationBreadcrumbTitle} subTitle={variationBreadcrumbSubTitle} />
                <CardBody className='breadcrumb-space'>
                    <Breadcrumb className='breadcrumb-no-divider mb-0 gap-2'>
                        <BreadcrumbItem className='ps-0 mb-1 mb-xl-0' tag='a' href={Href}> {HomeArrow} </BreadcrumbItem>
