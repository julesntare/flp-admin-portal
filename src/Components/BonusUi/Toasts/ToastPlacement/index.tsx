...
import { toastPlacementOptions, toastPlacementSubTitle } from '../../../../Data/BonusUiData/ToastsData'
        ...
        <Col sm={12}>
            <Card>
                ...
                <CardBody className='toast-rtl toast-dark'>
                    <Form>
                        <FormGroup>
                            <Input className='mt-2' name='toastPlacement' id='toastPlacement' type='select' value={selectedPosition}
