...
export default function AppIdeasTimeline() {
    return (
        <VerticalTimelineElement className='cd-timeline-block' date='February 02 2022' icon={<div className="cd-timeline-img cd-picture bg-primary"><i className="icon-pencil-alt" /></div>}>
