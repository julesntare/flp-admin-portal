...
export default function MeetUpTimeline() {
    return (
        <VerticalTimelineElement className='cd-timeline-block' date='November 04 2022' icon={<div className="cd-timeline-img cd-location bg-secondary"><i className="icon-pin-alt" /></div>}>
            <div className="cd-timeline-content">
                <div className='timeline-wrapper'>
                    <Badges color='success'>{MeetUp}</Badges>
                </div>
                <H5 className='f-w-500 m-0'>{"Web-designer's meet-up "}</H5>
