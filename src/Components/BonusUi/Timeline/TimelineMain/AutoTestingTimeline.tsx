...
export default function AutoTestingTimeline() {
    return (
        <VerticalTimelineElement className='cd-timeline-block' date='June 12 2022' icon={<div className="cd-timeline-img cd-location bg-info"><i className="icon-pulse" /></div>}>
            <div className="cd-timeline-content">
                <div className='timeline-wrapper'>
                    <Badges color='primary'>{AudioTesting}</Badges>
                </div>
                <H5 className='f-w-500 m-0'>{'Musical trends and predictability'}</H5>
