...
import { darkCardSubTitle } from '../../../../Data/BonusUiData/BasicCardData'
...
export default function DarkCard() {
    return (
        <Col sm={12}>
            <Card>
                <CommonCardHeader headClass='pb-0 bg-dark' titleClass='text-white' title={DarkCardTitle} subTitle={darkCardSubTitle} />
                ...
                <CardFooter className='bg-dark'>
                    <H6 className='mb-0'>{CardFooterText}</H6>
                </CardFooter>
            </Card>
        </Col>
    )
