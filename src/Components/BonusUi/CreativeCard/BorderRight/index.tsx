...
import { borderRightSubTitle } from '../../../../Data/BonusUiData/BasicCardData'
...
export default function BorderRight() {
    return (
        <Col md={6} xs={12}>
            <Card>
                <CommonCardHeader title={BorderRightTitle} subTitle={borderRightSubTitle} headClass='border-r-secondary pb-0' />
                <CardBody>
