...
import { borderTopSubTitle } from '../../../../Data/BonusUiData/BasicCardData'
...
export default function BorderTop() {
    return (
        <Col md={6} xs={12}>
            <Card>
                <CommonCardHeader title={BorderTopTitle} subTitle={borderTopSubTitle} headClass='border-t-danger pb-0' />
                <CardBody>
                    <P className="mb-0">
