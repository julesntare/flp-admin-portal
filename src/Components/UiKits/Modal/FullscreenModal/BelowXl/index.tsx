...
import { FullscreenBelowXl, UXDesigner, WebDesign, WedDesigner } from '../../../../../Utils/Constants';
...
function BelowXl() {
    ...
    return (
        <Fragment>
            <Btn color='primary-2x' outline={true} type="button" onClick={toggle} >{FullscreenBelowXl}</Btn>
