...
import { FullscreenBelowMd, UXDesigner, WebDesign, WedDesigner } from '../../../../../Utils/Constants';
...
function BelowMd() {
    ...
    return (
        <Fragment>
            <Btn color='success-2x' outline={true} type="button" onClick={toggle} >{FullscreenBelowMd}</Btn>
