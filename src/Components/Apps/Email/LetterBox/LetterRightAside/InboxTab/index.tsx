...
import { addToFavorites, handleEnvelope, handleInterview, removeItems } from '../../../../../../redux-toolkit/reducers/LetterBoxReducer'
                                ...
                                <div className="email-data">
                                    ...
                                    {item.badge &&
                                        item.badge.map((data, i) => (
                                            <Badges color="transparent" className={`badge-light-${data.color}`} key={i} onClick={handleValue}> {data.title} </Badges>
                                        ))}
                                </div>
