            ...
            <Table className="table-responsive" style={{ width: "100%" }} borderless>
                <tbody>
                    <tr style={{ padding: "28px 0 5px", display: "flex", justifyContent: "space-between" }} >
                        ...
                        <td>
                            <Image className='for-light' style={{height:50, marginBottom: 14}} src={dynamicImage(`logo/logo.png`)} alt="logo" />
                            <Image className='for-dark' style={{height:50, marginBottom: 14}} src={dynamicImage(`logo/logo.png`)} alt="logo" />
