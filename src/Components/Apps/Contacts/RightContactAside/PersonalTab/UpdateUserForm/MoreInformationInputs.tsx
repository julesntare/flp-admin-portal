...
import { dayList, monthList } from '../../../../../../Data/AppsData/Bookmark&ContactData'
    ...
    <Row className="g-2 more-data">
      <Col md={12} className="mt-0">
        <FormGroup>
          <Label>{'URLS'}</Label>
          <Row>
            <Col lg={6} sm={6}><Input type="text" required /></Col>
            <Col lg={4} sm={6}>
      ...
      <Col md={12}>
        <FormGroup>
          ...
          <Row>
            ...
            <Col sm={6}><div className="mb-2"><Input type="text" placeholder="Pin Code" /></div></Col>
          </Row>
        </FormGroup>
      </Col>
    </Row>
