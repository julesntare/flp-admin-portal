...
import { changeChat, createNewChatAsync } from '../../../../../../redux-toolkit/reducers/ChatReducer';
import { Badges, Image, LI, P, UL } from '../../../../../../AbstractElements';
import SideHeader from '../Common/SideHeader';
import { AllMembersType, ChatConversation } from '../../../../../../Types/ChatType';
                ...
                <UL className="chats-user simple-list">
                    {members
                        ...
                        .map((item: AllMembersType, i: number) => {
                            return (
                                <LI key={i} className={`common-space d-flex ${activeChat === item.id && 'active'}`} onClick={() => changeChatClick(item.id)}>
