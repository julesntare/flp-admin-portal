...
import { fetchChatMemberAsync, setChats, setSelectedUser } from '../../../../../../redux-toolkit/reducers/ChatReducer';
import { Image } from '../../../../../../AbstractElements';
import { dynamicImage } from '../../../../../../Utils';
import { AllMembersType, ChatType, MessagesType } from '../../../../../../Types/ChatType';
        ...
        <>
            {allMembers && chats && selectedUser ? (
                <div className="msger-chat">
                    ...
                    ) : (<Image className='img-fluid' src={dynamicImage("start-conversion.jpg")} alt='start conversion' body={true} />
                    )}
