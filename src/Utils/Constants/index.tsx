...
export const BottomRightToastBodyText: string = "Your time over after 5 minute.";
...
export const DunzoProfile: string = "Dunzo Profiles For New Employees:";
...
export const OpenModalDunzo: string = "Open modal for Dunzo";
...
export const DunzoLoginText: string ="Fill in your information below to continue.";
export const Email: string = "Email";
export const CheckMeOut: string = "Check me out";
export const CustomModalsTitle: string = "Dunzo custom modals";
...
export const BalanceText: string = "Example of Dunzo dashboard balance card.";
export const TextModal: string = "Example of Dunzo dashboard profile card.";
export const ResultText: string = "Example of Dunzo login form.";
...
export const WithExampleLinkCheck: string = 'with an example link.Check it out.';
...
export const ImageGalleryDescriptionTitle: string = "IMAGE GALLERY WITH DESCRIPTION";
export const PortfolioTitle: string = "Portfolio Title";
export const MasonryGalleryTitle: string = "Masonry Gallery";
export const MasonryDescriptionTitle: string = "Masonry Gallery With Description";
...
export const EnterEmailPassword: string = "Enter your email & password to login";
...
export const SubContent: string = "Our Site is Currently under maintenance We will be back Shortly";
...
export const CopyFormText: string = "Web design is the process of creating websites ";
...
export const VariationActivitiesTitle: string = "Which of the following activities do you enjoy doing in your free time?";
...
export const SampleCardSpan: string = "lorem ipsum dolor sit amet, consectetur adipisicing elit";
...
export const WhyThisPositionText: string = "Why do you want to take this position?";
...
export const HoverFresherText2: string = "A fresher's interview is to be conducted";
export const MollyBoake: string = "Molly Boake";
export const HoverMeetupText1: string = "US Meeting";
export const HoverMeetupText2: string = "2209 Leverton Cove RoadSpringfield, MA 01109";
...
export const ActiveDisablePageTitle: string = "Pagination With Active And Disabled"
...
export const Profile2Head: string ="Wonderful piece that successfully conveys the magnificence of the mountains and the natural world.";
export const Profile2Text: string = " English Romantic painter, printer, and watercolourist ";
...
export const BlogShadowText: string = "Accusamus et iusto odio dignissimos ducimus qui blanditiis.";
...
export const ContactHistoryNotModified: string = "Contact has not been modified yet.";
